    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav">Halaman ini memuat informasi Tempat alat Pendeteksi Dini Banjir</p>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-striped table-admin">
                                <thead>
                                    <tr>
                                        <th width="auto">No.</th>
                                        <th width="auto">Nama alat</th>
                                        <th width="auto">Alamat</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $data = file_get_contents('http://localhost/SIG-BANJIR/ambildata.php');
                                    $no = 1;
                                        ...
                                        <td class="center">
                                            <div class="btn-group p-20">
                                                <a href="detail.php?id_alat=<?php echo $item->id_alat; ?>" rel="tooltip"
                                                    data-original-title="Lihat File" data-placement="top"
