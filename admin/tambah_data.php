                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal style-form" action="tambah_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="latitude" class="form-control" type="text" id="latitude" placeholder="-7.3811577" required />
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">Longitude</label>
                                                <input name="longitude" class="form-control" type="text" id="longitude" placeholder="109.2550945" required />
                                            </div>
                                            <div class="form-group">
