  ...
  <div id="app">
    ...
    <div id="main">
      ...
      <script>
            ...
            .then(data => {
              ...
              Object.values(dataByAlat).forEach(function(alatData) {
                chartData.datasets.push({
                  label: 'Jarak(cm) - ' + alatData.namaAlat,
                  data: alatData.jarak,
        ...
        setInterval(updateChart, 2000); // Update the chart every 2 seconds.
      </script>
</body>
