                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_data.php?id_alat=<?php echo $d['id_alat']; ?> " class="btn btn-primary"><span class="fas fa-edit"></a>
                                                <a href="hapus_aksi.php?id_alat=<?php echo $d['id_alat']; ?>" class="btn btn-danger delete-link"><span class="fas fa-trash"></span></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
